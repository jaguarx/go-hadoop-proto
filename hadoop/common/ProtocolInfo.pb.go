...
func (*GetProtocolVersionsRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d96100c9ab0d0b5, []int{0}
}
...
func (m *GetProtocolVersionsRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetProtocolVersionsRequestProto.Merge(m, src)
}
...
func (*ProtocolVersionProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d96100c9ab0d0b5, []int{1}
}
...
func (m *ProtocolVersionProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolVersionProto.Merge(m, src)
}
...
func (*GetProtocolVersionsResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d96100c9ab0d0b5, []int{2}
}
...
func (m *GetProtocolVersionsResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetProtocolVersionsResponseProto.Merge(m, src)
}
...
func (*GetProtocolSignatureRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d96100c9ab0d0b5, []int{3}
}
...
func (m *GetProtocolSignatureRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetProtocolSignatureRequestProto.Merge(m, src)
}
...
func (*GetProtocolSignatureResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d96100c9ab0d0b5, []int{4}
}
...
func (m *GetProtocolSignatureResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetProtocolSignatureResponseProto.Merge(m, src)
}
...
func (*ProtocolSignatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d96100c9ab0d0b5, []int{5}
}
...
func (m *ProtocolSignatureProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtocolSignatureProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("ProtocolInfo.proto", fileDescriptor_6d96100c9ab0d0b5) }

var fileDescriptor_6d96100c9ab0d0b5 = []byte{
