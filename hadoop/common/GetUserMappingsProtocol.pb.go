...
func (*GetGroupsForUserRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b674b6da649ac1a, []int{0}
}
...
func (m *GetGroupsForUserRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetGroupsForUserRequestProto.Merge(m, src)
}
...
func (*GetGroupsForUserResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b674b6da649ac1a, []int{1}
}
...
func (m *GetGroupsForUserResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetGroupsForUserResponseProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("GetUserMappingsProtocol.proto", fileDescriptor_2b674b6da649ac1a) }

var fileDescriptor_2b674b6da649ac1a = []byte{
