...
func (*RefreshUserToGroupsMappingsRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_bca648b8933b4b38, []int{0}
}
...
func (m *RefreshUserToGroupsMappingsRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshUserToGroupsMappingsRequestProto.Merge(m, src)
}
...
func (*RefreshUserToGroupsMappingsResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_bca648b8933b4b38, []int{1}
}
...
func (m *RefreshUserToGroupsMappingsResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshUserToGroupsMappingsResponseProto.Merge(m, src)
}
...
func (*RefreshSuperUserGroupsConfigurationRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_bca648b8933b4b38, []int{2}
}
...
func (m *RefreshSuperUserGroupsConfigurationRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshSuperUserGroupsConfigurationRequestProto.Merge(m, src)
}
...
func (*RefreshSuperUserGroupsConfigurationResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_bca648b8933b4b38, []int{3}
}
...
func (m *RefreshSuperUserGroupsConfigurationResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshSuperUserGroupsConfigurationResponseProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("RefreshUserMappingsProtocol.proto", fileDescriptor_bca648b8933b4b38) }

var fileDescriptor_bca648b8933b4b38 = []byte{
