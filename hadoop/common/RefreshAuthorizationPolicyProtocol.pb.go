...
func (*RefreshServiceAclRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_719759380acbbe98, []int{0}
}
...
func (m *RefreshServiceAclRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshServiceAclRequestProto.Merge(m, src)
}
...
func (*RefreshServiceAclResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_719759380acbbe98, []int{1}
}
...
func (m *RefreshServiceAclResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshServiceAclResponseProto.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("RefreshAuthorizationPolicyProtocol.proto", fileDescriptor_719759380acbbe98)
}

var fileDescriptor_719759380acbbe98 = []byte{
