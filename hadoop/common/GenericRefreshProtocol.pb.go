...
func (*GenericRefreshRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9a4fdf20077dcde, []int{0}
}
...
func (m *GenericRefreshRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenericRefreshRequestProto.Merge(m, src)
}
...
func (*GenericRefreshResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9a4fdf20077dcde, []int{1}
}
...
func (m *GenericRefreshResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenericRefreshResponseProto.Merge(m, src)
}
...
func (*GenericRefreshResponseCollectionProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9a4fdf20077dcde, []int{2}
}
...
func (m *GenericRefreshResponseCollectionProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenericRefreshResponseCollectionProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("GenericRefreshProtocol.proto", fileDescriptor_f9a4fdf20077dcde) }

var fileDescriptor_f9a4fdf20077dcde = []byte{
