...
func (*ListSpanReceiversRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{0}
}
...
func (m *ListSpanReceiversRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListSpanReceiversRequestProto.Merge(m, src)
}
...
func (*SpanReceiverListInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{1}
}
...
func (m *SpanReceiverListInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SpanReceiverListInfo.Merge(m, src)
}
...
func (*ListSpanReceiversResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{2}
}
...
func (m *ListSpanReceiversResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListSpanReceiversResponseProto.Merge(m, src)
}
...
func (*ConfigPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{3}
}
...
func (m *ConfigPair) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfigPair.Merge(m, src)
}
...
func (*AddSpanReceiverRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{4}
}
...
func (m *AddSpanReceiverRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddSpanReceiverRequestProto.Merge(m, src)
}
...
func (*AddSpanReceiverResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{5}
}
...
func (m *AddSpanReceiverResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddSpanReceiverResponseProto.Merge(m, src)
}
...
func (*RemoveSpanReceiverRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{6}
}
...
func (m *RemoveSpanReceiverRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoveSpanReceiverRequestProto.Merge(m, src)
}
...
func (*RemoveSpanReceiverResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8caba3cc071f11d9, []int{7}
}
...
func (m *RemoveSpanReceiverResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoveSpanReceiverResponseProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("TraceAdmin.proto", fileDescriptor_8caba3cc071f11d9) }

var fileDescriptor_8caba3cc071f11d9 = []byte{
