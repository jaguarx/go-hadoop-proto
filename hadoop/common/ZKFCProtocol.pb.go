...
func (*CedeActiveRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b49ab88947732c8, []int{0}
}
...
func (m *CedeActiveRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CedeActiveRequestProto.Merge(m, src)
}
...
func (*CedeActiveResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b49ab88947732c8, []int{1}
}
...
func (m *CedeActiveResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CedeActiveResponseProto.Merge(m, src)
}
...
func (*GracefulFailoverRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b49ab88947732c8, []int{2}
}
...
func (m *GracefulFailoverRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GracefulFailoverRequestProto.Merge(m, src)
}
...
func (*GracefulFailoverResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b49ab88947732c8, []int{3}
}
...
func (m *GracefulFailoverResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GracefulFailoverResponseProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("ZKFCProtocol.proto", fileDescriptor_3b49ab88947732c8) }

var fileDescriptor_3b49ab88947732c8 = []byte{
