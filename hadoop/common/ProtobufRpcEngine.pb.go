...
func (*RequestHeaderProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_858d1695acd46bc2, []int{0}
}
...
func (m *RequestHeaderProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestHeaderProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("ProtobufRpcEngine.proto", fileDescriptor_858d1695acd46bc2) }

var fileDescriptor_858d1695acd46bc2 = []byte{
