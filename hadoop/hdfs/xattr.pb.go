...
func (XAttrSetFlagProto) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{0}
}
...
func (XAttrProto_XAttrNamespaceProto) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{0, 0}
}
...
func (m *XAttrProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_XAttrProto.Merge(m, src)
}
...
func (*SetXAttrRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{1}
}
...
func (m *SetXAttrRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetXAttrRequestProto.Merge(m, src)
}
...
func (*SetXAttrResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{2}
}
...
func (m *SetXAttrResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetXAttrResponseProto.Merge(m, src)
}
...
func (*GetXAttrsRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{3}
}
...
func (m *GetXAttrsRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetXAttrsRequestProto.Merge(m, src)
}
...
func (*GetXAttrsResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{4}
}
...
func (m *GetXAttrsResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetXAttrsResponseProto.Merge(m, src)
}
...
func (*ListXAttrsRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{5}
}
...
func (m *ListXAttrsRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListXAttrsRequestProto.Merge(m, src)
}
...
func (*ListXAttrsResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{6}
}
...
func (m *ListXAttrsResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListXAttrsResponseProto.Merge(m, src)
}
...
func (*RemoveXAttrRequestProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{7}
}
...
func (m *RemoveXAttrRequestProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoveXAttrRequestProto.Merge(m, src)
}
...
func (*RemoveXAttrResponseProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_b5deb1e99d886349, []int{8}
}
...
func (m *RemoveXAttrResponseProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoveXAttrResponseProto.Merge(m, src)
}
...
func init() { proto.RegisterFile("xattr.proto", fileDescriptor_b5deb1e99d886349) }

var fileDescriptor_b5deb1e99d886349 = []byte{
